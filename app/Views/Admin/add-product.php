...
<?php endif; ?> 
                                ...
                                <div class="mb-12">
                                    ...
                                    <input type="text" id="price" name="price" class="form-control" placeholder="Nhập price">
                                </div>
                                <div class="mb-12">
                                    <label for="pricesale">Price Sale</label>
                                    <input type="text" id="pricesale" name="pricesale" class="form-control" placeholder="Nhập pricesale">
                                </div>
                                <div class="mb-12">
                                ...
                                <div class="mb-12">
                                    ...
                                    <input type="file" id="image_main" name="image_main"class="form-control" accept="image/*" placeholder="Chọn ảnh">
                                </div>
                                <div class="mb-12">

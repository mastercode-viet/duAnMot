...
?>
                                ...
                                <div class="mb-12">
                                    ...
                                    <input type="text" id="address" name="address" class="form-control" placeholder="Nhập address">
                                </div>
                                <div class="mb-12">
                                    <label for="phone">Phone</label>
                                    <input type="number" id="phone" name="phone" class="form-control" placeholder="Nhập phone">
                                </div>
                                <div class="mb-12">

                                        ...
                                        <ul class="flex flex-column">
                                            <?php foreach ($listProduct as $key => $value): ?>
                                                <li class="wg-product item-row ">
                                                    ...
                                                    <div class="body-text text-main-dark mt-4"><img src="<?= $value->image_main ?>" alt="" width="60"></div>
                                                    <div class="body-text text-main-dark mt-4"><?=$value->categoryName?></div>
                                                    <div class="body-text text-main-dark mt-4">
                                                    <?= number_format($value->price ?? 0, 0, ',', '.') ?>VNĐ 
                                                    <?php
                                                    if ($value->price_sale !=  null) {
                                                        echo "-". number_format($value->price_sale ?? 0, 0, ',', '.') . 'VNĐ';
                                                    } 
                                                    ?>
                                                    </div>

                                ...
                                <div class="wg-box">
                                    ...
                                    <div class="wg-table table-product-list">
                                        <ul class="table-title flex gap12 mb-6">
                                            ...
                                            <li>
                                                <div class="body-title">Ation</div>
                                            </li>
                                            ...
                                            <?php foreach ($commentDetail as $key => $value): ?>
                                                <li class="wg-product item-row ">
                                                    ...
                                                    <div class="list-icon-function">
                                                        <div class="item eye">
                                                            <button class="btn btn-success " data-bs-toggle="modal" data-bs-target="#exampleModal" data-comment="<? $value->id ?>">Reply</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="<?= BASE_URL?>?role=admin&act=comment-reply" method="post">
                                        ...
                                        <div class="modal-body">
                                            <textarea name="reply" class="form-control" placeholder="nội dung trả lời"></textarea>
                                        </div>

<div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="https://themesflat.co/html/ecomus/assets/Admin/image/logo/logo.svg" data-light="../assets/Admin/image/logo/logo.svg" data-dark="https://themesflat.co/html/ecomus/assets/Admin/image/logo/logo-white.svg" >
                        </a>
                        ...
                        <div class="center">
                            <div class="center-item">
                                <ul class="">
                                    ...
                                    ?>
                                    ">
                                        <a href="<?php echo BASE_URL?>?role=admin&act=home" class="">
                                            <div class="icon">
                                    ...
                                    <li class="menu-item has-children
                                     <?php
                                        if (isset($_GET['act']) && ($_GET['act'] == 'all-category' || $_GET['act'] == 'add-category' || $_GET['act'] == 'update-category' || $_GET['act'] == 'delete-category' || $_GET['act'] == 'show-category')) {
                                            echo 'active';
                                        }
                                    ?>">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="<?php echo BASE_URL?>?role=admin&act=all-category" class="">
                                                    <div class="text">Category list</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="<?php echo BASE_URL?>?role=admin&act=add-category" class="">
                                    ...
                                    <?php
                                        if (isset($_GET['act']) && ($_GET['act'] == 'all-user' || $_GET['act'] == 'add-user' || $_GET['act'] == 'update-user')) {
                                            echo 'active';
                                        }
                                    ?>
                                    ...
                                    ">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="<?php echo BASE_URL?>?role=admin&act=all-user" class="">
                                                    <div class="text">All user</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="<?php echo BASE_URL?>?role=admin&act=add-user" class="">
                                    ...
                                    <li class="menu-item">
                                        <a href="<?php echo BASE_URL?>?role=admin&act=comment-product" class="">
                                            <div class="icon"><i class="icon-pie-chart"></i></div>
                                            <div class="text">Comment</div>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="<?php echo BASE_URL?>?role=admin&act=logout" class="">
                                            <div class="icon">

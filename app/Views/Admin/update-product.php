                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                <div class="wg-box">
                                    ...
                                    ?>
                                    <form action="<?php echo BASE_URL ?>?role=admin&act=update-post-product&id=<?= $_GET['id']?>" method="post"
                                     ...
                                     <option value="<?php echo htmlspecialchars($value->id) ?>
                                            <?php if ($value->id == $product->category_id) {
                                              echo "selected";
                                             }
                                                        ?>
                                    ...
                                    <?php endif; ?>  -->
                                                <?php foreach ($listCategory as $value): ?>
                                                    <option value="<?php echo $value->id ?>" <?php echo isset($product->category_id) && $product->category_id == $value->id ? 'selected' : '' ?>>
                                        ...
                                        <div class="mb-12">
                                            ...
                                            <input type="text" id="price" name="price" class="form-control"
                                                placeholder="Nhập price" value="<?php echo $product->price ?>">
                                        </div>
                                        <div class="mb-12">
                                            <label for="pricesale">Price Sale</label>
                                            <input type="text" id="pricesale" name="pricesale" class="form-control"
                                                placeholder="Nhập pricesale" value="<?php echo $product->price_sale ?>">
                                        </div>
                                        <div class="mb-12">
                                        ...
                                        <div class="mb-12">
                                            ...
                                            <img src="<?php echo $product->image_main ?>" alt="" width="60">
                                            <input type="file" id="image_main" name="image_main" class="form-control"
                                                accept="image/*" placeholder="Chọn ảnh">
                                        </div>
                                        <div class="mb-12">
    ...
    <script>
        ...
        <?php if (count($listProductImage) > 0) : ?>
            ...
            UI = `
                                       ...
                                       <div class="d-flex">
                                        <input type="file" class="form-control" name="image[]" accept="image/*" placeholder="Chọn ảnh">

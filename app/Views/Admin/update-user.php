...
?>
                                    ...
                                    <form action="<?= BASE_URL ?>?role=admin&act=update-post-user&id=<?= isset($_GET['id']) ? $_GET['id'] : '' ?>" method="post" enctype="multipart/form-data">

                                <div class="mb-12">
                                    <label for="name">Name</label>
                                    <input type="text" id="name" name="name" class="form-control"  value="<?php echo $user->name ?>"placeholder="Nhập tên">
                                </div>
                                <div class="mb-12">
                                ...
                                <div class="mb-12">
                                    ...
                                    <input type="number" id="phone" name="phone" class="form-control" value="<?php echo $user->phone ?>"
                                     placeholder="Nhập phone">
                                </div>
                                <div class="mb-12">
                                    <label for="image">Image</label>
                                    <img src="value="<?php echo $user->image ?>"" alt="" width="50px">
                                    <input type="file" id="image" name="image" accept="image/*" class="form-control" placeholder="Chọn ảnh">
                                </div>
                                <div class="mb-12">
